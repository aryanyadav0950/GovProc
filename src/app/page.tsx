      ...
      <header className="border-b border-slate-800 bg-slate-950/80 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-7xl mx-auto flex h-16 items-center justify-between px-6">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-indigo-700 font-black text-white shadow-lg shadow-blue-500/20 text-sm tracking-wider">
              GP
            </div>
            <div>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 py-12 md:py-16 space-y-16">
        <div className="text-center max-w-4xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-800 bg-blue-950/60 px-4 py-1.5 text-xs font-bold text-blue-300">
            ...
            <span>Autonomous Procurement & Sandbox Lifecycle — GFR Rule 194</span>
          </div>
